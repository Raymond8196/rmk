...
| Dynamic RADIO interrupt dispatcher | ⬜ Phase 1 PoC |
| BLE stack encapsulation (trouble-host pause/restart) | ⬜ Phase 2 |
| Unified ConnectionManager + keycode switching | ⬜ Phase 3 |
